          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              formData = {
                ...
                // Преобразуем в число
                category_id: parseInt(document.getElementById("StartupCathegory").value),
                // Преобразуем в число
                description: document.getElementById("Description").value.trim(),
                start_m: parseInt(document.getElementById("Start_m").value),
                investments_m: parseInt(document.getElementById("Investments_m").value),
                crowdfunding_m: parseFloat(document.getElementById("Crowdfunding_m").value),
                ...
                tech_investment: parseInt(document.getElementById("Techological_m").value),
                competition_level: document.getElementById("Competition").value,
                competitor_count: parseInt(document.getElementById("CompetititorCount").value),
                demand_level: document.getElementById("DemandLevel").value,
                social_impact: document.getElementById("DemandIdx").value,
                audience_reach: parseInt(document.getElementById("TargetAudience").value),
              ...
              _context.prev = 9;
              _context.next = 12;
              return fetch("http://127.0.0.1:8001/predict/full_form", {
                method: "POST",
                headers: {
            ...
            case 12:
              ...
              throw new Error("\u041E\u0448\u0438\u0431\u043A\u0430: ".concat(response.statusText));
            case 15:
              _context.next = 17;
            ...
            case 17:
              ...
              alert("\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442 \u043F\u0440\u0435\u0434\u0441\u043A\u0430\u0437\u0430\u043D\u0438\u044F: ".concat(JSON.stringify(result.prediction)));
              _context.next = 27;
              break;
            case 23:
              _context.prev = 23;
              _context.t0 = _context["catch"](9);
              console.error("Ошибка при отправке запроса:", _context.t0);
              alert("Не удалось выполнить предсказание. Проверьте консоль для подробностей.");
            case 27:
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","checkout.js"], null)
